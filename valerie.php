...
<body>
		...
		<h2>About Me</h2>
			...
			<p>
				<span>I</span>’m a sophomore at the University of Rochester majoring in data science with clusters in Chinese and Psychology. I am also the marketing director of the Hong Kong Students’ Association. As the marketing director, I update the club’s social media pages and create posters for events.</p>
		...
		<h2>First Jobs</h2>
			...
			<p>
				<span>M</span>y first job was at Mini Ivy Tutoring Center, where I tutored elementary and middle school students in math and English. In addition, I performed various office administrative duties, such as keeping track of attendance and picking up phone calls.</p>
		...
		<h2>Internships</h2>
			...
			<p>
				<span>I</span>n 2016, I interned with the Committee Against Anti-Asian Violence’s Asian Youth in Action program. As an intern, I worked with the Chinatown Tenants Union to help tenants challenge evictions and harassment from their landlords. I also interpreted for rent stabilized tenants sharing their stories at hearings to fight for a rent freeze. Working at this organization allowed me to realize that striving for a collective goal is not only necessary, but can also make housing justice for low income residents a reality.</p>
		...
		<h2>Courses</h2>
			...
			<p>
				<span>T</span>he easiest classes that I’ve taken here at the University of Rochester are CSC170, PSY101 and CHI102. I was able to deepen my knowledge of creating and designing web pages with CSC170. The concepts in PSY101 were not difficult to understand and the mini courses throughout the semester made the class more interesting. CHI102 was not a difficult course, but it required a lot of work and practice every day to understand the vocabulary and grammar concepts.</p>

			<p>
				<span>T</span>he harder classes include BIO110 and CHM131. For me, BIO110 was more difficult because it focused mainly on the molecular level of biology. CHM131 was fine until I started to learn about acids and titrations. Another class that was intense was MTH162. Even though the AP exam gave me a good foundation, a lot of the topics were difficult to understand, such as series.</p>

		</article>

		<footer>
			<div class="bottom">
			This webpage, by team Vancouver. Original Source <a href="http://csc174.org/assignment01/vtam/index.html">Initial Personal Webpage | Valerie</a>
			</div>
		</footer>
